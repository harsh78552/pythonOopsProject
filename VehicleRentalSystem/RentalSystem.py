		...
		try:
			...
			if checkSessionValidation:
				...
				if checkRentalRecordFound:
					...
					totalRentTime = abs(int(time.time()) - rentStartTime)
...
# vehicle = VehicleRentalProcess()
# vehicle.viewVehicle('harsh844509@gmail.com','BMW')
# vehicle.rentalProcessInitialize('harsh844509@gmail.com','BMW','X5','automatic')
vehicle = VehicleReturnProces('harsh844509@gmail.com', 'BMW', 'X5')
vehicle.returnProcess()
